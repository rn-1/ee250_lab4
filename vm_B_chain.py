...
# https://github.com/rn-1/ee250_lab4
...
def on_connect(client, userdata, flags, rc):
    ...
    """
    client.message_callback_add("user/pong", on_message_from_pong)
...
def on_message_from_user(client, userdata, message):
    print("Custom callback  - User Message: " + message.payload.decode())"""


def on_message_from_pong(client, userdata, message):
    received_num = int(message.payload.decode())
    print(f"Custom callback  - Pong Message: {received_num + 1}")
